	...
	def check 
      ...
      # respond_to do |format|
        ...
        if (msisdn.present?)
           ...
           # format.json { 
          render :text => [{account_no: '11111', account_status: 'ACTIVE', account_type: 'Savings', last_transaction_time: '05-JUN-2016 10:05:50 AM', msisdn: '919946359819##IOS##09062016125817-38864846799-1306572'},
...
# {account_no: '33333', account_status: 'ACTIVE', account_type: 'Savings', last_transaction_time: '07-JUN-2016 10:05:50 AM', msisdn: '919946359856##IOS##09062016125816-33864846799-1506572'}]}
          ...
          # format.json { 
          render :text => ({error: '500', response: 'failure'})
        end
      # end
  end
end
