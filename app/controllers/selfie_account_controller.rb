   ...
   def branches
    ...
    def upload_pan_image
    	...
    	respond_to do |format|
    		if uuid == "1234"
         	    # format.json {render :json =>{status_code: '200',status_message: 'success',response: {status: 'success'}}}
         	    format.json {render :json => {status_code: 200,status_message: 'success',response:{aadhaar_name:'KIREN PAUL',aadhaar_number: '889700488804',aadhaar_address: 'PARACKA HOUSE,SOUTH ATTARA,MOOKKANNOOR P O,MOOKKANNOOR,MOOKKANNUR,ERNAKULAM,KERALA',aadhaar_dob: 'null',aadhaar_fathers_name: 'null',aadhaar_yob: '1987',status: 'success'}}}
